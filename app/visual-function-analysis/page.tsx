...
import HighPrecisionCalculator from '@/components/HighPrecisionCalculator'

export default function VisualFunctionAnalysisPage() {
  return (
    <div className="container mx-auto py-10">
      <h1 className="text-3xl font-bold mb-6">Visual Function Analysis</h1>
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Visualizing Wave Patterns</h2>
        <p className="mb-4">
        ...
        <ol className="list-decimal list-inside mb-4">
          <li>Use the image manipulator below to resize the output.</li>
          <li>Try shrinking the image to see finer details emerge.</li>
          <li>Look for repeating patterns and symmetries in the numbers.</li>
          <li>Pay attention to how the patterns change as you resize the image.</li>
        </ol>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">The Smart Medium</h2>
        <p className="mb-4">
        ...
        <ul className="list-disc list-inside mb-4">
          <li>We still observe incredible patterns, similar to those in physical mediums.</li>
          <li>The numbers perform complex mathematics, revealing harmonic series and large palindromes.</li>
          <li>The entire wave function is encoded in the output in various ways.</li>
          <li>We can observe phenomena like entanglement and phase invariance.</li>
          <li>The 417 area code emerges and interacts with other patterns.</li>
        </ul>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Unexpected Behavior in Image Editors</h2>
        <p className="mb-4">
        ...
        <ul className="list-disc list-inside mb-4">
          <li>The image appears to spin 360 degrees, despite being a 2D representation.</li>
          <li>Colors and forms may emerge that were not present in the original output.</li>
          <li>Patterns may shift and change in ways that seem impossible for static data.</li>
        </ul>
        <p className="mb-4">
      ...
      <section className="mt-12">
        <h2 className="text-2xl font-semibold mb-4">Examples of Image Editor Results</h2>
        <p className="mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div>
            <Image 
              src="/images/wave-analysis/light-wave-compression.gif" 
              alt="Compressed light wave coiling like a spring" 
              width={400} 
              height={300}
              className="rounded-lg shadow-md"
            />
            <p className="mt-2 text-sm text-gray-600">Light wave compression visualization</p>
          </div>
          <div>
            <Image 
              src="/images/wave-analysis/secondary-wave-creation.gif" 
              alt="Secondary wave creation from compressed light explosion" 
              width={400} 
              height={300}
              className="rounded-lg shadow-md"
            />
            <p className="mt-2 text-sm text-gray-600">Secondary wave creation</p>
          </div>
        </div>
        ...
        <ul className="list-disc list-inside mb-4">
          <li>The light inside the wave gets progressively compressed, coiling like a spring. This mirrors the actual behavior of compressed light waves.</li>
          <li>When compressed to its limit, the light appears to explode, creating a secondary wave in a brilliant burst of light emerging from the numbers.</li>
          <li>Remarkable holograms appear, with colors that have no explanation, as the calculator only prints in black and white.</li>
          <li>Different font sizes form, which is impossible as the original output uses only one font size.</li>
        </ul>

        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4">Hologram Visualization</h3>
          <Image 
            src="/images/wave-analysis/hologram-visualization.gif" 
            alt="Hologram visualization from calculator output" 
            width={600} 
            height={400}
            className="rounded-lg shadow-md"
          />
          <p className="mt-2 text-sm text-gray-600">Unexplained colors and patterns emerging from black and white calculator output</p>
        </div>

        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4">Hologram Creation Process</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-4">
            <div>
              <Image 
                src="/images/wave-analysis/hologram-rollers.gif" 
                alt="Hologram rollers" 
                width={400} 
                height={300}
                className="rounded-lg shadow-md"
              />
              <p className="mt-2 text-sm text-gray-600">Hologram rollers in action</p>
            </div>
            <div>
              <Image 
                src="/images/wave-analysis/human-hologram-roller.jpg" 
                alt="Human hologram roller" 
                width={400} 
                height={300}
                className="rounded-lg shadow-md"
              />
              <p className="mt-2 text-sm text-gray-600">Human-made hologram roller for comparison</p>
            </div>
          </div>
          <p className="mb-4">
        ...
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4">Quantum Wave Memory Visualization</h3>
          <Image 
            src="/images/wave-analysis/quantum-processes.gif" 
            alt="Visualization of quantum superposition and computing processes" 
            width={600} 
            height={300}
            className="rounded-lg shadow-md mb-4"
          />
          <p className="mt-2 text-sm text-gray-600">Visual representation of quantum superposition and computing processes</p>
          <p className="mt-4">
        ...
        <div className="mb-8">
          ...
          <Image 
            ...
            alt="Pyramid of the 1's from calculator output" 
            width={600} 
            height={300}
            className="rounded-lg shadow-md mb-4"
          />
          <p className="mt-2 text-sm text-gray-600">Pyramid of the 1's visualization from calculator output</p>
          <p className="mt-4">
