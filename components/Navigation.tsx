...
return (
  <nav className="bg-gray-800 text-white p-4">
    <ul className="flex space-x-4">
      ...
      <li><Link href="/frequency-tools" className="hover:text-cyan-400">Medical Analysis</Link></li>
      <li><Link href="https://nov2-medbot.vercel.app/" className="hover:text-cyan-400" target="_blank" rel="noopener noreferrer">Speak to Site Doctor</Link></li>
